...
<div class={cn(
  "fixed left-1/2 -translate-x-1/2 flex gap-xs bg-white dark:bg-neutral shadow-lg rounded-full px-[1.5rem] py-3 duration-300 font-medium text-sm font-jost tracking-widest",
